...
var (
	...
	ErrSKUInvalid           = errors.BadRequest("BIZ_SKU_INVALID", "sku invalid")
	ErrShippingRequired     = errors.BadRequest("BIZ_SHIPPING_REQUIRED", "shipping address required")
	ErrShippingInvalid      = errors.BadRequest("BIZ_SHIPPING_INVALID", "shipping address invalid")
	...
	ErrWithdrawDailyCap     = errors.BadRequest("BIZ_WITHDRAW_DAILY_CAP", "超过单笔提现上限")
