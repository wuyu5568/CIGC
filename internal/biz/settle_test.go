...
func TestMatchCap(t *testing.T) {
	...
	cases := []struct {
		...
		{"23999.99999999", "8000"},
		{"24000", "16000"},
		{"35999.99999999", "16000"},
		{"36000", "24000"},
		{"49999.99999999", "24000"},
		{"50000", "30000"},
		{"69999.99999999", "30000"},
		{"70000", "42000"},
		{"99999.99999999", "42000"},
		{"100000", "60000"},
		{"159999.99999999", "60000"},
		{"160000", "100000"},
		{"200000", "100000"},
	}
...
func TestOrderStaticReleases_TodayLedgerAndPending(t *testing.T) {
	...
	if !rel.Coins.Equal(decimal.RequireFromString("10")) || !rel.ReleasedCoins.Equal(decimal.RequireFromString("0.03333333")) {
		t.Fatalf("coins=%s released_coins=%s", rel.Coins, rel.ReleasedCoins)
	}
